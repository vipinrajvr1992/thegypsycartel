...
/* ============================================
   ✅ GYPSY CARTEL — FLOATING WIDGET ENGINE (MASTER FINAL)
   WhatsApp + Zoho SalesIQ Premium Stack
   SAME Animation • NO DUPLICATES • NO LOOP • MOBILE SAFE
============================================ */

document.addEventListener("DOMContentLoaded", () => {

  /* ============================================
     ✅ PREMIUM ENTRANCE ANIMATION (SHARED)
  ============================================ */

  function premiumEntrance(el, delay = 400) {
    if (!el) return;
  ...
  if (!document.querySelector(".whatsapp-float")) {
    ...
    /* ✅ Same Premium Entrance */
    premiumEntrance(waBtn, 350);
  }

  /* ============================================
     ✅ 2. ZOHO SALESIQ PREMIUM ENGINE (BOTTOM)
     NO LOOP • SAME Animation • Mobile Safe Fix
  ============================================ */
  ...
  function activateZohoPremium() {
    ...
    /* ✅ Same Premium Entrance */
    premiumEntrance(zohoBtn, 450);

    console.log("Zoho Premium Activated ✅");

    /* ============================================
       ✅ MOBILE FIX — CLOSE BUTTON NEVER BLOCKS INPUT
    ============================================ */
    ...
    setTimeout(() => {
      ...
      if (closeBtn) {
        closeBtn.style.bottom = "110px"; /* ✅ Push Above Keyboard Area */
    ...
    /* ============================================
       ✅ FORCE SMALL CHAT WINDOW SIZE (JS Assist)
    ============================================ */
  ...
  /* ============================================
     ✅ Observe DOM Until Zoho Injects Widget
  ============================================ */
